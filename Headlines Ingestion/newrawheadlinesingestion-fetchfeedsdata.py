...
class PubSub:
    def __init__(self):
        self.topic_name = "NewRawHeadlinesIngestion_raw_feeds_data"
...
class Execute:
    """
    -> Get all the publisher Feed details 'from publishers.csv'
    ...
    def run(self):
        ...
        # with open('all_publishers_feed_samples.json', "w") as json_file:
