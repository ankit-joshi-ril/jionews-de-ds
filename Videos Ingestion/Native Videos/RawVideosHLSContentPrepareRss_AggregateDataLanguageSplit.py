...
class MongoDB:
    def __init__(self, pubsub):
        ...
        self.raw_videos_rss_collection = ingestion_db['raw_videos_rss']
    ...
    def aggregate_top_videos(self):
        ...
        try:
            aggregated_data = list(self.raw_videos_rss_collection.aggregate(pipeline, allowDiskUse=True))
    ...
    def publish_data_in_chunks(self, data):
        ...
        for batch in data:
            self.pubsub.publish_message_to_topic("RawVideosHLSContentPrepareRss_AggregatedDataLanguageSplit", batch)
...
class Execute:
    ...
    def run(self):
        ...
        # Save file locally
        # with open('transformed_data_videos_hls.json', 'w') as f:
